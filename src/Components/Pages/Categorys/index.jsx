      ...
      <ButtonStyles>
        ...
        <Container xs="12" sm="12" md="12" offset={4} >
          ...
          {showAddCat && (
           ...
           <AddCat onClose={handleToggleAddCategories} onAddCategory={handleAddCategory} />
         </div>
          )}
          ...
          >
            {showMore ? (
              <ArrowDropUpIcon sx={{ color: ColorThemes.Font.MidnightBlue }} />
            ) : (
              <ArrowDropDownIcon sx={{ color:ColorThemes.Font.MidnightBlue }} />
            )}
          </div>
        </Container>
        </div>
